        ...
        <div class="col">
            <div class="card border-info mb-3" style="max-width: 18rem;">
                ...
                <div class="card-body text-info">
                    <h5 id="sym1" class="card-title">{$record0}</h5>
                </div>
            </div>
        </div>
        <div class="col">
            <div class="card border-info mb-3" style="max-width: 18rem;">
                ...
                <div class="card-body text-info">
                    <h5 id="sym2" class="card-title">{$record1}</h5>
                </div>
            </div>
        </div>
        <div class="col">
            <div class="card border-info mb-3" style="max-width: 18rem;">
                ...
                <div class="card-body text-info">
                    <h5 id="sym3" class="card-title">{$record2}</h5>
                </div>
            </div>
        </div>
        <div class="col">
            <div class="card border-info mb-3" style="max-width: 18rem;">
                ...
                <div class="card-body text-info">
                    <h5 id="sym4" class="card-title">{$record3}</h5>
                </div>
            </div>
        </div>
    </div>
